...
function Home() {
  ...
  return (
    <div className="p-8 font-sans relative">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-20 px-6 text-center overflow-hidden">
      ...
      <img
        src="https://images.unsplash.com/photo-1616782441262-7b83f46fa3b2?auto=format&fit=crop&w=1920&q=80"
        alt="Car Hero"
